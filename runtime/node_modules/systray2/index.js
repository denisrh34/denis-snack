        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, fs.pathExists(binPath)];
                case 1:
                    if (!(_a.sent())) {
                        binPath = path.join(__dirname, 'traybin', binName);
                    }
                    if (!copyDir) return [3 /*break*/, 8];
                ...
                case 2:
                    _a.trys.push([2, 4, , 7]);
                    return [4 /*yield*/, fs.stat(copyDistPath)];
                case 3:
                    _a.sent();
                    return [3 /*break*/, 7];
                case 4:
                    error_1 = _a.sent();
                    return [4 /*yield*/, fs.ensureDir(copyDir)];
                case 5:
                    _a.sent();
                    return [4 /*yield*/, fs.copy(binPath, copyDistPath)];
                case 6:
                    _a.sent();
                    return [3 /*break*/, 7];
                case 7: return [2 /*return*/, copyDistPath];
                case 8: return [2 /*return*/, binPath];
            }
        });
    });
};
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        ...
                                        counter_1 = { id: 1 };
                                        conf.menu.items.forEach(function (_) { return addInternalId(_this.internalIdMap, _, counter_1); });
